...
export const DEFAULT_SITE_SETTINGS: SiteSettings = {
  ...
  founderImage: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&auto=format&fit=crop&q=80',
  ...
  foundersStoryBodyBn: 'কৃষক বাজার কোনো সাধারণ বাণিজ্যিক প্রতিষ্ঠান নয়; এটি একটি স্বপ্ন, একটি সংগ্রাম এবং আমাদের সন্তানদের ভবিষ্যৎ রক্ষার এক পবিত্র যুদ্ধ। এই পথচলার নেপথ্যে রয়েছে দুই সাধারণ মানুষের এক অসাধারণ সংকল্প, যাদের হৃদয় কেঁদে উঠেছিল এদেশের মাটি আর মানুষের কষ্ট দেখে।\n\nপ্রতিষ্ঠাতা জাকির হোসেন এবং সহ-প্রতিষ্ঠাতা আহসামুল হক রতনের যৌথ উদ্যোগে গড়ে ওঠা এই প্ল্যাটফর্মটির জন্ম হয়েছিল এক গভীর বেদনা এবং ক্ষোভ থেকে। প্রতিদিন সকালে যখন আমরা খবরের কাগজে দেখি যে, আমাদের প্রিয় সন্তানদের মুখে আমরা যে খাবার তুলে দিচ্ছি—তাতে মেশানো হচ্ছে মরণঘাতী ফরমালিন, কীটনাশক ও ক্ষতিকর সব কেমিক্যাল, তখন আমাদের হৃদপিণ্ড থমকে যায়। শাকসবজিতে উজ্জ্বলতা বাড়াতে স্প্রে করা হচ্ছে বিষাক্ত কেমিক্যাল, মাছে দেওয়া হচ্ছে ফরমালিন যা লাশ পচাতে ব্যবহৃত হয়, মাংসে মেশানো হচ্ছে ক্ষতিকর এন্টিবায়োটিক ও ঔষধ। এর ফলে আমাদের ঘরে ঘরে বেড়ে চলেছে ক্যান্সার, কিডনি বিকল এবং লিভার নষ্টের মতো মরণব্যাধি। সবচেয়ে বড় শিকার হচ্ছে আমাদের নিষ্পাপ শিশুরা, যাদের ভবিষ্যৎ এই বিষাক্ত খাদ্যের কারণে অন্ধকারের দিকে ধাবিত হচ্ছে।\n\nজাকির হোসেন সবসময় একটি কথা বিশ্বাস করতেন: "কৃষক দেশের সম্পদ।" অথচ, এদেশের মেরুদণ্ড সেই কৃষকই সবচেয়ে বেশি শোষিত ও অবহেলিত। রোদ-বৃষ্টি মাথায় নিয়ে যে কৃষক দিনরাত পরিশ্রম করে সোনার ফসল ফলান, আড়তদার ও মধ্যস্বত্বভোগীদের ফড়িয়া সিন্ডিকেটের কারণে সেই কৃষক তাঁর ফসলের ন্যায্য মূল্য পান না। ৮ টাকার ফসল ঘাটে ঘাটে দালালের হাত ঘুরে ঢাকায় এসে বিক্রি হয় ৮০ টাকায়। কৃষক তাঁর ঘামের দাম পান না, আর শহরের ক্রেতারা উচ্চমূল্যে বিষ কিনে খাচ্ছেন।\n\nএই নির্মম বাস্তবতাকে বদলাতে জাকির হোসেন ও আহসামুল হক রতন শুরু করলেন এক অসম লড়াই। কোনো বড় পুঁজি বা রাষ্ট্রীয় পৃষ্ঠপোষকতা ছাড়া, শুধু সৎ সাহস আর বুকভরা স্বপ্ন নিয়ে তাঁরা পাড়ি জমালেন বাংলাদেশের প্রত্যন্ত গ্রামে গ্রামে। তাঁরা কথা বললেন মাঠের কৃষকদের সাথে। কৃষকদের বললেন, "আপনারা আমাদের সাথে যুক্ত হোন। কোনো মধ্যস্বত্বভোগী থাকবে না, আড়তদার থাকবে না। আপনার ফসলের দাম আপনি নিজে নির্ধারণ করবেন। আমরা আপনার ফসল সরাসরি কাস্টমারের ঘরে পৌঁছে দেব।"\n\nপ্রথমে এই ধারণা বিশ্বাস করা সহজ ছিল না। যুগ যুগ ধরে চলা শোষণের শৃঙ্খল ভাঙা ছিল অত্যন্ত কঠিন। কিন্তু তাদের আন্তরিকতা ও সততা দেখে ধীরে ধীরে কৃষকেরা আশ্বস্ত হতে শুরু করলেন। সাইফুল ইসলাম, মান্নান হোসেন, সুরুজ মিয়ার মতো পরিশ্রমী কৃষকেরা এগিয়ে এলেন। গড়ে উঠল এক অনন্য কো-অপারেটিভ নেটওয়ার্ক।\n\nকৃষক বাজার-এর মূল কল্পনা হলো—সরাসরি ও সতেজ। যখন ঢাকায় একজন কাস্টমার অর্ডার করেন, আমাদের কৃষকেরা কাকডাকা ভোরে খেত থেকে ফসল তোলেন। কোনো কোল্ড স্টোরেজ বা হিমঘরে রাখা হয় না, কোনো কৃত্রিম প্রিজারভেটিভ ব্যবহার করা হয় না। সেই সতেজ ফসল সরাসরি পরিবহনে করে ঢাকায় নিয়ে এসে ২৪ ঘণ্টার মধ্যে ঘরে ঘরে পৌঁছে দেওয়া হয়। প্রতিটি খাদ্য আমাদের নিজস্ব ল্যাবে কঠোরভাবে পরীক্ষা করা হয় যাতে ক্ষতিকর ফরমালিন বা রাসায়নিকের কোনো উপস্থিতি না থাকে।\n\nএটি আমাদের যুদ্ধ—ভেজাল আর সিন্ডিকেটের বিরুদ্ধে। এটি আমাদের কল্পনা—একটি সোনার বাংলা গড়ে তোলার, যেখানে প্রতিটি মানুষ পাবে সুস্থ জীবন, প্রতিটি শিশু হাসবে কলকাকলিতে, আর প্রতিটি কৃষকের মুখ হাসবে তাঁর নিজের পরিশ্রমের ন্যায্য মূল্যে। আমাদের সন্তানরা যেন একটি সুস্থ, সুন্দর ও বিষমুক্ত পৃথিবীতে বড় হতে পারে, সেটাই আমাদের এই সংগ্রামের একমাত্র প্রাপ্তি ও অনুপ্রেরণা। কৃষক বাজার শুধু একটি বাজার নয়, এটি নিরাপদ ও খাঁটি খাদ্যের এক সামাজিক আন্দোলন।',
  foundersStoryBodyEn: 'Krishok Bazar is not just a commercial enterprise; it is a dream, a struggle, and a sacred war to protect the future of our children. Behind this journey lies the extraordinary resolve of two ordinary men whose hearts wept for the plight of our soil and its people.\n\nCo-founded by Zakir Hossain and Ahsamul Haque Ratan, this platform was born out of deep pain and righteous anger. Every morning, when we read in the newspapers that the very food we feed our beloved children is laced with deadly formalin, harmful pesticides, and toxic chemical dyes, our hearts skip a beat. Vegetables are sprayed with hazardous chemicals to enhance brightness, fish are preserved with formalin (a chemical used to preserve corpses), and meat is contaminated with excessive antibiotics and veterinary drugs. Consequently, catastrophic diseases like cancer, kidney failure, and liver damage are soaring in every household. The biggest victims are our innocent children, whose futures are being pushed into darkness by this toxic food system.\n\nZakir Hossain always believed in one core truth: "Farmers are the wealth of our country." Yet, the very backbone of our nation, the farmer, is the most exploited and neglected class. The farmer who works tirelessly day and night under scorching sun and heavy rain to grow golden crops does not receive a fair price for his harvest due to the predatory broker syndicates. Crops purchased for 8 BDT at the farm level are sold for 80 BDT in Dhaka after passing through multiple middlemen. While the farmers do not receive the value of their sweat, urban consumers are forced to buy toxic, adulterated food at exorbitant prices.\n\nTo alter this cruel reality, Zakir Hossain and Ahsamul Haque Ratan initiated an asymmetric battle. Without large capital or state backing, but armed with sheer courage and a heart full of dreams, they traveled to remote villages across Bangladesh. They spoke directly to grassroots farmers, telling them: "Join us. There will be no middlemen, no brokers. You will determine the price of your own harvest. We will deliver your crops directly to the consumer\'s doorstep."\n\nAt first, this concept was hard to believe. Breaking the shackles of exploitation that had existed for generations was extremely difficult. However, seeing their sincerity and honesty, farmers slowly began to trust them. Hardworking farmers like Saiful Islam, Mannan Hossain, and Suruj Mia stepped forward. Thus, a unique cooperative network was formed.\n\nThe core philosophy of Krishok Bazar is—Direct and Fresh. When a customer in Dhaka places an order, our farmers harvest the crops in the early dawn. No cold storage, no artificial preservatives, and no toxic chemicals are used. Those fresh crops are transported directly to Dhaka and delivered to households within 24 hours. Every single food item is rigorously checked in our quality lab to ensure 100% safety from formalin or toxic chemical residues.\n\nThis is our battle—against adulteration and syndicates. This is our imagination—of a Golden Bengal where every citizen lives a healthy life, every child grows up with a radiant smile, and every farmer smiles with the fair reward of his honest labor. Our struggle is driven by the sole aspiration that our children grow up in a safe, beautiful, and poison-free world. Krishok Bazar is not just a marketplace; it is a social revolution for safe and authentic food.'
};
