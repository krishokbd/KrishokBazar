...
যশোরে যে পেঁয়াজ কৃষক ২৫ টাকায় বিক্রি করেন, ঢাকার কাওরান বাজার হয়ে কাস্টমারের হাতে পৌঁছাতে তার দাম হয়ে যায় ৭০ থেকে ৮০ টাকা। মাঝখানে এই বিশাল ৫০-৫৫ টাকা ব্যবধান যায় মধ্যস্বত্বভোগীদের পকেটে। এর ফলে:
...
export const DEFAULT_SITE_SETTINGS: SiteSettings = {
  ...
  socialFacebook: 'https://www.facebook.com/people/%E0%A6%95%E0%A7%83%E0%A6%B7%E0%A6%95-%E0%A6%AC%E0%A6%BE%E0%A6%9C%E0%A6%BE%E0%A6%B0-Krishok-Bazar/61578459151972/',
  socialYoutube: 'https://www.youtube.com/@KrishokBazarBD',
  socialTwitter: 'https://www.tiktok.com/@krishokbazarbd',
  socialInstagram: 'https://www.instagram.com/krishokbazarbd/',
  ...
  // Default Founder Values
  founderNameBn: 'জাকির হোসেন',
  founderNameEn: 'Zakir Hossain',
  founderRoleBn: 'প্রতিষ্ঠাতা',
  founderRoleEn: 'Founder',
  founderImage: '/src/assets/images/founder_zakir_1782809224788.jpg',
  founderBioBn: 'কৃষক বাজার-এর প্রতিষ্ঠাতা জাকির হোসেন একজন স্বপ্নবাজ তরুণ উদ্যোক্তা। তাঁর জীবনের মূল দর্শন হলো "কৃষক দেশের সম্পদ"। তিনি বিশ্বাস করেন যে, আমাদের দেশের সোনার মাটির সন্তান এই মেহনতি কৃষকদের অক্লান্ত পরিশ্রমে ও পবিত্র ঘামেই এদেশ বেঁচে আছে। অথচ, বাজার ব্যবস্থার গভীর অসঙ্গতি ও অসাধু সিন্ডিকেটের কারণে উৎপাদক নিজে ন্যায্য মূল্য পান না এবং ভোক্তারা বিষাক্ত কেমিক্যাল ও ভেজাল খাবার কিনে প্রতারিত হচ্ছেন। জাকির হোসেনের স্বপ্ন হলো এমন এক বাংলাদেশ গড়ে তোলা, যেখানে প্রতিটি কৃষক সরাসরি তাঁর কঠোর মেহনতের সঠিক মূল্য নিজে নির্ধারণ করবেন এবং দেশের প্রতিটি শিশু পাবে রাসায়নিক মুক্ত, শতভাগ সতেজ ও পুষ্টিকর নিরাপদ খাবার।',
  founderBioEn: 'Zakir Hossain, the founder of Krishok Bazar, is a visionary young entrepreneur. His primary life philosophy is "Farmers are the wealth of our country." He strongly believes that our nation thrives on the tireless labor and sacred sweat of our hardworking farmers. Yet, due to deep inconsistencies in the market system and unethical syndicates, the growers themselves are deprived of fair prices while consumers are deceived with toxic, chemical-adulterated foods. Zakir\'s dream is to build a Bangladesh where every farmer can directly set the price of their sweat and toil, and every child receives chemical-free, 100% fresh, and nutritious safe food.',

  coFounderNameBn: 'আহসামুল হক রতন',
  coFounderNameEn: 'Ahsamul Haque Ratan',
  coFounderRoleBn: 'সহ-প্রতিষ্ঠাতা',
  coFounderRoleEn: 'Co-Founder',
  coFounderImage: '/src/assets/images/cofounder_ratan_1782809246938.jpg',
  coFounderBioBn: 'কৃষক বাজার-এর সহ-প্রতিষ্ঠাতা Ahsamul Haque Ratan (আহসামুল হক রতন) একজন নিষ্ঠাবান সমাজসেবী ও অভিজ্ঞ ব্যক্তিত্ব। তাঁর একমাত্র অঙ্গীকার হলো—"দেশের প্রতিটি মানুষের কাছে বিষমুক্ত ও নিরাপদ খাদ্য পৌঁছে দেওয়া।" তিনি গভীরভাবে লক্ষ্য করেছেন কিভাবে আধুনিক বাজার ব্যবস্থায় শাকসবজি, ফলমূল, মাছ ও মাংসে ফরমালিন, রাসায়নিক ঔষধ ও ক্ষতিকর প্রিজারভেটিভ ব্যবহার করে দেশের ভবিষ্যৎ প্রজন্ম তথা নিষ্পাপ শিশুদের স্বাস্থ্যকে এক ভয়াবহ ঝুঁকির মুখে ঠেলে দেওয়া হচ্ছে। তিনি জাকির হোসেনের পাশে দাঁড়িয়ে নিজের জীবনকে উৎসর্গ করেছেন ভেজালমুক্ত সতেজ খাবারের একটি সুস্থ পরিবেশ বিনির্মাণে, যেখানে মানুষ সুস্থ থাকবে এবং কৃষক তাঁর আত্মসম্মান ফিরে পাবে।',
  coFounderBioEn: 'Ahsamul Haque Ratan, the co-founder of Krishok Bazar, is a dedicated social worker and an experienced community leader. His singular commitment is—"To deliver chemical-free and safe food to every citizen of the country." He has deeply observed how the modern market system, through the overuse of formalin, chemical injections, and harmful preservatives in fruits, vegetables, fish, and meat, is pushing the future generation and innocent children into catastrophic health crises. Standing shoulder to shoulder with Zakir Hossain, he has committed his efforts to creating a healthy, adulteration-free food supply chain so people can live healthily and farmers can regain their ultimate dignity.',

  foundersStoryTitleBn: 'আমাদের সংগ্রাম, আমাদের কল্পনা, এবং একটি বিষমুক্ত সোনার বাংলার জন্মকথা',
  foundersStoryTitleEn: 'Our Struggle, Our Imagination, and the Birth of a Poison-Free Golden Bengal',
  foundersStoryBodyBn: 'কৃষক বাজার কোনো সাধারণ বাণিজ্যিক প্রতিষ্ঠান বা নিছক একটি ব্যবসা নয়; এটি একটি স্বপ্ন, একটি দীর্ঘ সংগ্রাম, রক্তে ভেজা আত্মত্যাগ এবং আমাদের নিষ্পাপ সন্তানদের ভবিষ্যৎ সুরক্ষার এক আপসহীন যুদ্ধ। এই মহৎ পথচলার নেপথ্যে রয়েছে দুই সাধারণ মানুষের এক অসাধারণ সংকল্প, যাদের হৃদয় প্রতিদিন রক্তাক্ত হয়েছিল এদেশের অবহেলিত কৃষক এবং রাসায়নিক বিষে জর্জরিত নিষ্পাপ শিশুদের মুখ দেখে।\n\nপ্রতিষ্ঠাতা জাকির হোসেন এবং সহ-প্রতিষ্ঠাতা আহসামুল হক রতনের যৌথ উদ্যোগে গড়ে ওঠা এই বৈপ্লবিক প্ল্যাটফর্মটির জন্ম হয়েছিল এক গভীর বেদনা, কান্না ও তীব্র ক্ষোভ থেকে। প্রতিদিন সকালে যখন আমরা খবরের কাগজে চোখ রাখি, তখন আমাদের গা শিউরে ওঠে। আমরা কাস্টমারেরা যে খাবার অত্যন্ত আদরের সাথে আমাদের সোনামণিদের মুখে তুলে দিচ্ছি—তাতে মেশানো হচ্ছে মরণঘাতী ফরমালিন, ক্ষতিকর প্রিজারভেটিভ, বিষাক্ত কার্বাইড এবং ক্যানসার সৃষ্টিকারী কেমিক্যাল রঞ্জক। বাজারে পাওয়া প্রতিটি লাল টকটকে আপেল, চকচকে বেগুন বা হলুদ পাকা কলার আড়ালে লুকিয়ে থাকে মরণ বিষ। শাকসবজি সুন্দর ও আকর্ষণীয় দেখাতে ব্যবহৃত হচ্ছে মারাত্মক বিষাক্ত তরল কেমিক্যাল ও রাসায়নিক স্প্রে। যে মাছ আমাদের প্রিয় সন্তানরা ভালোবাসে, তা সতেজ ও পচনহীন রাখতে নির্দ্বিধায় ঢেলে দেওয়া হচ্ছে ফরমালিন, যা মূলত লাশ পচাতে ব্যবহৃত হয়! এমনকি হাঁস-মুরগির মাংস বা দুধেও মিশে যাচ্ছে ক্ষতিকর অ্যান্টিবায়োটিক ও হরমোন ইনজেকশন, যা শিশুদের শরীরের স্বাভাবিক বৃদ্ধিকে বাধাগ্রস্ত করছে এবং তাদের নিয়ে যাচ্ছে অকাল মৃত্যুর দিকে।\n\nএর ভয়াবহ পরিণতিতে আজ আমাদের ঘরে ঘরে থাবা বসিয়েছে মরণব্যাধি ক্যানসার, লিভার সিরোসিস, কিডনি বিকল এবং ফুসফুসের চিরস্থায়ী জটিলতার মতো নিষ্ঠুর রোগ। যে বয়সে আমাদের বাচ্চারা মাঠে দাপিয়ে বেড়ানোর কথা, সেই বয়সে আজ তারা হাসপাতালের নিবিড় পরিচর্যা কেন্দ্রে ধুঁকে ধুঁকে কাঁদছে। এই হৃদবিদারক দৃশ্য আমরা আর মুখ বুজে সইতে পারিনি। আমরা শপথ নিয়েছি, এই বিষাক্ত ব্যবসা ও সিন্ডিকেটের হাত থেকে আমাদের ভবিষ্যৎ প্রজন্মকে বাঁচাতেই হবে।\n\nপ্রতিষ্ঠাতা জাকির হোসেনের জীবনের মূল দর্শন হলো: "কৃষক দেশের সম্পদ।" অথচ আমাদের প্রিয় মাতৃভূমির মেরুদণ্ড যে মেহনতি কৃষক, তারা আমাদের সমাজব্যবস্থায় সবচেয়ে শোষিত ও বঞ্চিত শ্রেণী। রোদে পুড়ে, বৃষ্টিতে ভিজে, হাড়ভাঙা খাটুনি দিয়ে যে কৃষক আমাদের থালার অন্ন জোগান, তারা আড়তদার ও মধ্যস্বত্বভোগী ফড়িয়া সিন্ডিকেটের নির্মম কবলে পড়ে নিজেদের ঘামের দামটুকুও পান না। মাঠের যে ফসল কৃষক ১০ টাকায় বিক্রি করতে বাধ্য হন, ঢাকার খুচরা বাজারে দালালের হাত ঘুরে তা সাধারণ ভোক্তাদের কিনতে হয় ১০০ টাকায়! কৃষক পায় না তার শ্রমের মর্যাদা, আর ক্রেতা পায় না বিশুদ্ধ খাবার। এই মধ্যবর্তী কমিশন সংস্কৃতির কারণে কৃষকেরা ঋণের বোঝায় জর্জরিত হয়ে আত্মহত্যা করছেন, আর অন্যদিকে আমাদের সন্তানরা বিষাক্ত খাবার খেয়ে তিল তিল করে শেষ হয়ে যাচ্ছে।\n\nএই অমানবিক ও নির্মম শোষণ ব্যবস্থার চিরতরে অবসান ঘটাতে জাকির হোসেন এবং সহ-প্রতিষ্ঠাতা আহসামুল হক রতন শুরু করলেন এক অসম ও অসম সাহসিক লড়াই। বড় কোনো ব্যাংক ঋণ বা কোটি টাকার পুঁজি ছাড়াই, শুধু দৃঢ় সংকল্প এবং বুকভরা সততা নিয়ে তাঁরা বাংলাদেশের প্রত্যন্ত গ্রামের পর গ্রাম চষে বেড়িয়েছেন। তাঁরা সরাসরি কথা বলেছেন মাঠের খেটে খাওয়া প্রান্তিক কৃষকদের সাথে। কৃষকদের দুচোখে চোখ রেখে তাঁরা বলেছিলেন, "আপনারা আমাদের বিশ্বাস করুন। আমাদের মাঝে কোনো দালালের স্থান নেই, কোনো আড়তদার থাকবে না। আপনার ফসলের নায্য দাম আপনি নিজে নির্ধারণ করবেন। আমরা আপনার ফসল সরাসরি কাস্টমারের রান্নাঘরে পৌঁছে দেব।"\n\nযুগ যুগ ধরে চলা শোষণের শৃঙ্খল ভাঙা ছিল অসম্ভব এক চ্যালেঞ্জ। প্রথমে অনেকেই তাঁদের এই স্বপ্নকে অবাস্তব মনে করেছিল এবং বাধা সৃষ্টি করার সবরকম চেষ্টা করেছিল। কিন্তু তাঁদের সীমাহীন সততা, দিনরাত মাঠে পড়ে থাকার ত্যাগ এবং কৃষকদের কল্যাণে অবিচল নিষ্ঠা দেখে ধীরে ধীরে কৃষকেরা তাঁদের উপর পূর্ণ বিশ্বাস স্থাপন করলেন। সাইফুল ইসলাম, মান্নান হোসেন ও সুরুজ মিয়ার মতো সহজ-সরল পরিশ্রমী কৃষকেরা লাঙল কাঁধে নিয়ে প্রথম তাঁদের হাত ধরলেন। জন্ম নিল কৃষক বাজার কো-অপারেটিভ নেটওয়ার্ক।\n\nকৃষক বাজার-এর মূল কল্পনা হলো—সরাসরি, সতেজ এবং বিষমুক্ত। যখন ঢাকায় একজন সম্মানিত কাস্টমার আমাদের অ্যাপে বা ওয়েবসাইটে অর্ডার করেন, আমাদের কৃষকেরা কাকডাকা ভোরে সরাসরি খেত থেকে তাজা শাকসবজি ও ফলমূল সংগ্রহ করেন। কোনো হিমাগার বা নোংরা কোল্ড স্টোরেজে পণ্য জমিয়ে রাখা হয় না, কোনো কৃত্রিম প্রিজারভেটিভ স্প্রে করা হয় না। মাঠ থেকে সরাসরি নিজস্ব পরিবহনের মাধ্যমে সেই ফসল ঢাকায় নিয়ে আসা হয় এবং মাত্র ২৪ ঘণ্টার মধ্যে সতেজ অবস্থায় কাস্টমারের দোরগোড়ায় পৌঁছে দেওয়া হয়। প্রতিটি ব্যাচ আমাদের নিজস্ব অত্যাধুনিক কোয়ালিটি ল্যাবে কঠোরভাবে পরীক্ষা করা হয় যাতে ফরমালিন বা কোনো ক্ষতিকারক কীটনাশকের বিন্দুমাত্র অবশিষ্টাংশ না থাকে।\n\nএটি কেবল কোনো পণ্য বিক্রির প্ল্যাটফর্ম নয়; এটি একটি সামাজিক আন্দোলন। এটি একটি যুদ্ধ—কৃত্রিম সিন্ডিকেট, মুনাফাখোরী অসাধু ব্যবসায়ী ও খাদ্য ভেজালকারীদের বিরুদ্ধে। এটি আমাদের কল্পনা—একটি সুস্থ, সতেজ ও স্বনির্ভর সোনার বাংলা গড়ে তোলার, যেখানে দেশের কোনো শিশুকে হাসপাতালের বিছানায় বিষাক্ত খাবারের যন্ত্রণায় কাঁদতে হবে না, প্রতিটি শিশুই সুস্থভাবে বেড়ে উঠবে, আর প্রতিটি কৃষকের কপালে থাকবে না কোনো ঋণের দুশ্চিন্তা, তাঁদের মুখ হাসবে নিজের মেহনতের সঠিক পাওনা অর্জনের শান্তিতে। আমাদের এই সংগ্রামে আপনার একটি ছোট্ট পদক্ষেপ আমাদের ভবিষ্যৎ প্রজন্মকে একটি নিরাপদ, সুস্থ ও খাঁটি পৃথিবী উপহার দিতে পারে। আসুন, কৃষক বাজারে যোগ দিয়ে আমরা সবাই মিলে গড়ে তুলি বিষমুক্ত সোনার বাংলাদেশ।',
  foundersStoryBodyEn: 'Krishok Bazar is not merely a commercial entity or a standard e-commerce store; it is a sacred dream, an epic struggle, a story of sweat and tears, and an uncompromising war to protect the health and future of our innocent children. Behind this journey lies the extraordinary resolve of two ordinary citizens whose hearts bled seeing the plight of our exploited farmers and the slow poisoning of our precious future generation.\n\nCo-founded by Zakir Hossain and Ahsamul Haque Ratan, this revolutionary platform was born out of profound pain, empathy, and righteous anger. Every single morning, as we read the headlines of national newspapers, our hearts break. We realize that the very food we feed our beloved children—fruits, vegetables, milk, and fish—is being heavily laced with deadly formalin, harmful food coloring, toxic carbide, and cancerous chemical preservatives. Unscrupulous middlemen and profit-greedy syndicates spray hazardous chemicals on fresh produce just to make them appear shiny and long-lasting. The fish our children love is soaked in formalin (a highly toxic chemical used to preserve corpses) to bypass natural decay, while poultry and meat are heavily contaminated with excessive growth hormones and non-prescribed veterinary antibiotics. Consequently, catastrophic diseases like childhood cancer, kidney failures, liver damage, and cognitive developmental issues are skyrocketing in every single household. Our innocent children are paying the ultimate price for this toxic food chain with their lives.\n\nZakir Hossain always held onto a singular, unshakeable truth: "Farmers are the wealth of our nation." Yet, the very backbone of our beautiful country, the hardworking farmers, are the most exploited, neglected, and vulnerable community in our current social hierarchy. The farmer who works from dawn to dusk under scorching heat and torrential rain to grow golden crops never receives a fair price for his harvest. Due to complex broker networks and greedy syndicates, crops bought for 10 BDT at the farm level are sold for 100 BDT to urban consumers in Dhaka. While the farmer remains trapped in a vicious cycle of poverty and high-interest loans, consumers in the cities are forced to spend their hard-earned money to buy slow poison. Zakir Hossain and Ahsamul Haque Ratan decided that this cruelty must end.\n\nTo alter this devastating reality, they initiated an asymmetric battle. Armed with no heavy bank loans or massive initial capital, but carrying an unbreakable resolve and absolute honesty, they set foot in the most remote villages of Bangladesh. They sat on the dusty fields and spoke directly to the grassroots organic growers, looking straight into their eyes and promising: "Trust us. There will be no middlemen, no brokers, and no commissions. You will set the price of your own sweat and labor, and we will carry your organic harvest directly to the consumer\'s doorstep."\n\nBreaking the shackles of generations-old exploitation was a near-impossible challenge. They faced intense resistance and threats from powerful syndicates who did not want their corrupt profit channels destroyed. But seeing their absolute sincerity, their transparency, and their tireless presence in the rural mud, the farmers slowly began to believe. Hardworking organic growers like Saiful Islam, Mannan Hossain, and Suruj Mia took the first step of courage and shook their hands. Thus, a transparent cooperative farming network was born.\n\nThe core operating philosophy of Krishok Bazar is—Direct, Fresh, and 100% Poison-Free. When an urban family in Dhaka places an order on our app, our farmers harvest the crops at the crack of dawn. No cold storage, no artificial preservatives, and no toxic chemical washes are used. These freshly harvested crops are carefully packed and transported to Dhaka within hours, reaching families within 24 hours of harvest. Furthermore, every batch is strictly tested in our quality control setup to guarantee absolute safety from formalin, pesticides, and heavy metal residues.\n\nThis is our holy war—against toxic food adulteration and manipulative syndicates. This is our dream—of a healthy, self-reliant Golden Bengal where no child has to suffer from terminal illnesses caused by toxic foods, where every child grows up with a radiant smile and boundless energy, and where every organic farmer lives with dignity and receives a fair reward for his honest labor. Your participation in our movement is not just a commercial transaction; it is a vote for a toxic-free, healthy future for the children of Bangladesh. Let us build a poison-free, thriving nation together.',
  visionTitleBn: 'আমাদের দূরদর্শী ভিশন',
  visionTitleEn: 'Our Strategic Vision',
  visionBodyBn: 'একটি সুখী, স্বনির্ভর ও সুস্থ বাংলাদেশ বিনির্মাণ করা, যেখানে দেশের প্রতিটি মানুষ কোনো রকম দ্বিধা ছাড়াই সম্পূর্ণ রাসায়নিক মুক্ত, তাজা ও সতেজ খাবার খাওয়ার সুযোগ পাবে। সেই সাথে দেশের অর্থনৈতিক মেরুদণ্ড সেই প্রান্তিক কৃষকেরা যেন মধ্যস্বত্বভোগী সিন্ডিকেটের হাত থেকে পুরোপুরি মুক্ত হয়ে নিজেদের কঠোর মেহনতের স্বাধীন ও নায্য মূল্য লাভ করতে পারেন।',
  visionBodyEn: 'To build a healthy, self-reliant, and thriving Bangladesh where every family has seamless access to 100% chemical-free, fresh, and nutritious food, while rural farmers are fully liberated from predatory syndicates, empowered with direct digital commerce to set their own fair prices.',
  missionTitleBn: 'আমাদের উৎসর্গীকৃত মিশন',
  missionTitleEn: 'Our Core Mission',
  missionBodyBn: '১. দালাল ও মধ্যস্বত্বভোগীহীন সরাসরি ডিজিটাল এগ্রো-মার্কেটপ্লেস স্থাপন করা।\n২. প্রান্তিক চাষীদের নিজস্ব মোবাইল ওয়ালেটের মাধ্যমে সরাসরি পেমেন্ট সুবিধা নিশ্চিত করে তাদের আর্থ-সামাজিক অবস্থার বৈপ্লবিক উন্নয়ন ঘটানো।\n৩. ঢাকা ও প্রধান শহরগুলোতে মাত্র ৬ থেকে ১২ ঘণ্টার মধ্যে এলাকা-ভিত্তিক এক্সপ্রেস ডেলিভারির মাধ্যমে সরাসরি খেত থেকে তাজা ও পুষ্টিকর ফসল কাস্টমারের রান্নাঘরে ডেলিভারি করা।\n৪. কৃষি খাতের ডিজিটাল ক্ষমতায়ন এবং তরুণ সমাজকে আধুনিক স্মার্ট কৃষিতে উদ্বুদ্ধ করা।',
  missionBodyEn: '1. Establish a fully transparent, middleman-free digital agricultural marketplace connecting consumers directly to local growers.\n2. Enable instant direct-to-wallet mobile payments for farmers to break the cycle of predatory loans.\n3. Implement a rapid 6-to-12-hour area-specific express delivery network to preserve maximum freshness and nutritional value.\n4. Foster technological literacy in rural agriculture and inspire the youth to pursue modern, smart farming.',
  foodSafetyTitleBn: 'খাদ্য নিরাপত্তা ও ল্যাব স্ট্যান্ডার্ড',
  foodSafetyTitleEn: 'Food Safety & Rigorous Lab Standards',
  foodSafetyBodyBn: 'আমাদের প্রতিটি খাদ্যপণ্য কঠোর মাননিয়ন্ত্রণ প্রক্রিয়ার মধ্য দিয়ে যায়। আমরা নিজস্ব কোয়ালিটি কন্ট্রোল ল্যাব ও পোর্টেবল টেস্টিং কিট ব্যবহার করি যাতে ফসলে কোনো ফরমালিন, রাসায়নিক বা বিষাক্ত কীটনাশকের অবশিষ্টাংশ না থাকে। আমরা সম্পূর্ণ ট্রেসিবিলিটি নিশ্চিত করি, যার অর্থ হলো আপনার কেনা প্রতিটি পণ্য কোন কৃষকের খেত থেকে এসেছে এবং কখন তোলা হয়েছে তা আপনি শতভাগ জানতে পারবেন। কোনো হিমঘর বা দীর্ঘমেয়াদী কোল্ড স্টোরেজে কেমিক্যাল প্রিজারভেটিভ দিয়ে পণ্য সংরক্ষণ করা আমাদের এখানে সম্পূর্ণ নিষিদ্ধ।',
  foodSafetyBodyEn: 'Every single batch of fresh harvest undergoes rigid quality checks at our sorting hubs. Using specialized testing kits and rapid lab analysis, we strictly screen for formalin, toxic carbides, and pesticide residues. We operate on a 100% transparent traceability model, letting you know exactly which verified farmer harvested your produce and at what hour. The use of artificial preservation chemicals or storing food in commercial cold storage facilities is strictly prohibited in our operations.'
};
