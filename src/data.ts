...
const itemsCategorized: Record<string, Array<{title: string, descBn: string, price: number, unit: string, isDiscount?: boolean}>> = {
  vegetables: [
    ...
    { title: 'সাদা বড় তাজা ফুলকপি (White Cauliflower)', descBn: 'তাজা ও পরিষ্কার পোকা মুক্ত গোল কড়া সাদা পাতাযুক্ত ফুলকপি।', price: 42, unit: 'piece' },
    { title: 'ক্ষেতের কচি সবুজ গোল বাঁধাকপি (Cabbage)', descBn: 'তাজা রসালো পাতামোড়ানো কপি ফুল, সম্পূর্ণ প্রাকৃতিক জৈব সারে উর্বর।', price: 38, unit: 'piece' },
    { title: 'গাছপাকা লাল টুকটুকে টমেটো (Red Tomato)', descBn: 'গাছপাকা কুচকুচে লাল টমেটো, সালাদ ও তরকারি ঘন করার জন্য উপযুক্ত।', price: 78, unit: 'kg' },
    { title: 'মিষ্টি ও মচমচে তাজা গাজর (Sweet Carrots)', descBn: 'সুস্বাদু রসালো মিষ্টি গাজর। জুস, সালাদ বা সুস্বাদু হালুয়া তৈরির মূল উপাদান।', price: 92, unit: 'kg', isDiscount: true },
    { title: 'ক্ষেতের কচি তিতাহীন শসা (Fresh Cucumber)', descBn: 'সালাদের জন্য উপযুক্ত রসালো কচি ও চকচকে সবুজ টাটকা শসা।', price: 58, unit: 'kg' }
  ],
  fruits: [
    { title: 'রাজশাহীর বাঘা থেকে তাজা গোপালভোগ আম (Gopalbhog)', descBn: 'ফরমালিন বিহীন সরাসরি রাজশাহী বাঘা থেকে সংগৃহীত অত্যন্ত মিষ্টি গোপালভোগ আম।', price: 95, unit: 'kg' },
    { title: 'রংপুরের বিখ্যাত হাঁড়িভাঙ্গা আম (Harivanga Mango)', descBn: 'রংপুর থেকে আসা বিখ্যাত হাঁড়িভাঙ্গা আম, আঁশহীন ও রাজকীয় সুবাস যুক্ত।', price: 125, unit: 'kg' },
    { title: 'দিনাজপুরের বেদানা কড়কড়ে লিচু (Bedana Litchi)', descBn: 'দিনাজপুর সদর থেকে সংগৃহীত রসালো বেদানা ও বোম্বাই লিচু শতভাগ তাজা।', price: 390, unit: '100 pcs', isDiscount: true },
    { title: 'আঠাহীন সুমিষ্ট পাকা কাঁঠাল (Sweet Jackfruit)', descBn: 'জাতীয় ফল পাকা মিষ্টি কাঁঠাল, সুমিষ্ট বড় কোয়া সমৃদ্ধ।', price: 260, unit: 'piece' },
    { title: 'স্বরূপকাঠীর সুমিষ্ট পেয়ারা (Green Guava)', descBn: 'ঝালকাঠি ও স্বরূপকাঠীর ভাসমান কড়া পেয়ারা, সুমিষ্ট ও অত্যন্ত মচমচে।', price: 72, unit: 'kg' },
    { title: 'ভিটামিন যুক্ত পাকা পেঁপে (Ripe Papaya)', descBn: 'গাছপাকা ফরমালিন মুক্ত অতি মিষ্টি আকর্ষণীয় পাকা পেঁপে।', price: 82, unit: 'kg' },
    { title: 'সবরি কলার তাজা কাঁদি (Sabri Banana)', descBn: 'প্রাকৃতিক উপায়ে উনানে পাকানো পুষ্টিকর সবরি কলার বড় এক ডজন।', price: 95, unit: 'dozen' },
    { title: 'পটুয়াখালীর মিষ্টি লাল তরমুজ (Watermelon)', descBn: 'মাঠ থেকে সরাসরি সংগৃহীত রসালো মিষ্টি ও জমকালো লাল তরমুজ আস্ত।', price: 240, unit: 'piece', isDiscount: true },
    { title: 'খাগড়াছড়ির জলডুগি আনারস (Pineapple)', descBn: 'পাহাড় থেকে তোলা অত্যন্ত রসালো ছোট আকারের জাঁকালো মিষ্টি আনারস।', price: 48, unit: 'piece' },
    { title: 'টুকটুকে লাল বড় দানা ডালিম (Anar)', descBn: 'স্বাদ ও রসালো বিচিতে সেরা লাল ডালিম ফল। রক্তস্বল্পতায় দারুণ কার্যকরী।', price: 290, unit: 'kg' },
    { title: 'পার্বত্য অঞ্চলের মিষ্টি মাল্টা (Green Malta)', descBn: 'বান্দরবানের পাহাড়ি বাগানের সম্পূর্ণ মিষ্টি রসে ভরা সবুজ দেশি মাল্টা।', price: 145, unit: 'kg' },
    { title: 'সিলেটের জারা লেবু ও কমলা (Sweet Orange)', descBn: 'শ্রীমঙ্গলের পাহাড়ি বাগান থেকে সংগৃহীত টক-মিষ্টি অত্যন্ত রসালো কমলা লেবু।', price: 195, unit: 'kg' },
    { title: 'নারিকেল বাগানের কচি ডাব (Green Coconut)', descBn: 'অত্যন্ত মিষ্টি জল ভরা কচি ডাব যা শরীরের পানিশূন্যতা সহজে দূর করবে।', price: 85, unit: 'piece' },
    { title: 'পার্বত্য ড্রাগন ফল পিংক দানা (Dragon Fruit)', descBn: 'তাজা ও সম্পূর্ণ রাসায়নিক মুক্ত পিঙ্ক ও লাল শাঁসের ড্রাগন ফ্রুট।', price: 330, unit: 'kg' },
    { title: 'বাগেরহাটের মিষ্টি জাম্বুরা (Red Pomelo)', descBn: 'রসালো টুকটুকে লাল দানার খোসা পাতলা বড় জাম্বুরা। অসাধারণ সুঘ্রাণ।', price: 55, unit: 'piece' }
  ],
  rice: [
    ...
    { title: 'বাসমতী সুগন্ধি লাহোরি চাল (Basmati Rice)', descBn: 'বিলাসবহুল বিরিয়ানি রান্নার কড়া লম্বা সুবাসিত চিকন বাসমতী চাল।', price: 195, unit: 'kg' },
    ...
    { title: 'অটমিল ও যই ভাঙা চাল কুড়ি (Oats Red Rice)', descBn: 'সকালের সুষম পুষ্টি ডায়েটের জন্য উপযুক্ত ভাঙা নাল চালের মন্ড।', price: 110, unit: 'kg' }
  ],
  fish: [
  ...
  meat: [
    ...
    { title: 'দেশী রাজহাঁসের ড্রেসড পিস কাট (Rajhans Cut)', descBn: 'চামড়াসহ সুনিপুণভাবে কাটা রাজহাঁসের টুকরো যা সরাসরি কড়াইয়ে দেওয়ার উপযোগী।', price: 550, unit: '550g' },
    { title: 'খাসির ভুঁড়ি ও বট ভালোভাবে ধোয়া (Mutton Bot)', descBn: 'আঁশ ও ময়লা ছাড়িয়ে লবণ ও হলুদ দিয়ে ধুয়ে পরিষ্কার করা চর্বিমুক্ত খাসির ভুঁড়ি।', price: 460, unit: 'kg' }
  ],
  eggs: [
    { title: 'দেশী মুক্ত চারণ মুরগির লাল ডিম (Local Eggs)', descBn: 'বাড়ির উঠানে ধান-পোকা খাওয়া খাঁটি দেশী মুরগির কড়া লাল ও সুস্বাদু ডিম।', price: 155, unit: 'dozen' },
    { title: 'বিল চারণ হাঁসের বড় সাদা ডিম (Duck Eggs)', descBn: 'হাঁসের বড় সাইজের জাঁতি ডিম, রান্নায় ও ভাজিতে দারুণ আঠালো কুসুম সমৃদ্ধ।', price: 165, unit: 'dozen' },
    { title: 'বাচ্চাদের পুষ্টিকর কোয়েল পাখির ডিম (Quail Eggs)', descBn: 'ছোট চিত্রবিচিত্র কোয়েল পাখির ডিম যা প্রোটিন ও ক্যালসিয়ামে ভরপুর।', price: 45, unit: '10 pcs' },
    { title: 'অর্গানিক খামারি লাল ডিম ১ ম গ্রেড (Farm Eggs)', descBn: 'উচ্চমানের ভিটামিন ফিড খাওয়ানো মুরগির বড় কুসুম সমৃদ্ধ তাজা লাল ডিম।', price: 135, unit: 'dozen' },
    { title: 'দেশী চিনা হাঁসের বড় ক্রিম ডিম (Chena Eggs)', descBn: 'আকারে বড় এবং চর্বিসমৃদ্ধ ভারী ওজনের চিনা হাঁসের কড়া স্বাদের ডিম।', price: 170, unit: 'dozen' },
    { title: 'মুক্ত চারণ ডিম ওমেগা-৩ ও ডি সমৃদ্ধ (Omega-3)', descBn: 'কড লিভার অয়েল ও অর্গানিক সুষম খাবার খাওয়ানো মুরগির ওমেগা ডিম।', price: 180, unit: 'dozen', isDiscount: true },
    { title: 'ডাবল কুসুমযুক্ত স্পেশাল বাতির ডিম (Double Yolk)', descBn: 'প্রতিটি ডিমে জোড়া লাল কুসুম সমৃদ্ধ অত্যন্ত বিরল ও চমৎকার কড়া ডিম।', price: 210, unit: '10 pcs' },
...
export const DEFAULT_SITE_SETTINGS: SiteSettings = {
  ...
  paymentBkashNumber: '01931355398',
  paymentNagadNumber: '01811223344',
